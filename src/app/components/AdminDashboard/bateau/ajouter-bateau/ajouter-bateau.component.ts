...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, BodyComponent, SideNavComponent, AdminDashboardComponent, RouterModule, RouterLink,RouterLinkActive,RouterOutlet],
  templateUrl: './ajouter-bateau.component.html',
  styleUrl: './ajouter-bateau.component.css'
})
export class AjouterBateauComponent {
