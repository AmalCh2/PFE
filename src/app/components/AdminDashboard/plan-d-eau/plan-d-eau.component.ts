import {  HostListener,Component, NgModule,OnInit, Input } from '@angular/core';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,BodyComponent,SideNavComponent,AdminDashboardComponent,RouterOutlet,RouterLink,RouterLinkActive,RouterOutlet],
  templateUrl: './plan-d-eau.component.html',
  styleUrl: './plan-d-eau.component.css'
})
export class PlanDEauComponent {
